...
vector<int> first(Matrix); // function that returns first required sequence from given matrix

vector<int> second(Matrix); // function that returns second required sequence from given matrix
